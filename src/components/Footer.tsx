...
const Footer = () => {
  const socialLinks = [
    ...
    {
      name: "Instagram",
      url: "https://www.instagram.com/liepnet",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "TikTok",
      url: "https://www.tiktok.com/@liepnet",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-1">
                  <a 
                    href="mailto:matiss.apsitis@liepnet.id.lv" 
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-1">
                  <a 
                    href="mailto:giorgos.k@liepnet.id.lv" 
                    className="text-gray-300 hover:text-white transition-colors text-sm block"
                  >
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <p className="text-gray-500 text-xs">
              Building the future of connectivity and digital services.
            </p>
          </div>
        </div>
      </div>
