...
const translations = {
  en: {
    ...
    // About page content
    aboutWhatsLiepnet: "WHAT'S LIEPNET™?",
    aboutOurMission: 'OUR MISSION',
    aboutMission1Title: "LATVIA'S FIRST NON-PROFIT CROWDSOURCED METEOROLOGICAL NETWORK",
    aboutMission1Desc: 'Our objective is to establish the first non-profit crowdsourced meteorological network in Latvia, which will offer real-time data at no cost and supplementary data for a nominal fee.',
    aboutMission2Title: 'AFFORDABLE HOSTING SOLUTIONS',
    aboutMission2Desc: 'Our goal is to provide affordable hosting services for businesses and individuals, regardless of whether they require website hosting, radio station software hosting, or Discord bot hosting.',
    aboutMission3Title: 'ASSISTING BUSINESSES WITH TECHNICAL ISSUES',
    aboutMission3Desc: 'We aim to assist Latvian companies in dealing with technological challenges and developing far better solutions; we can assist businesses with WI-FI and network planning.',
    aboutOurHistory: 'OUR HISTORY',
    aboutFoundedIn: 'FOUNDED IN FEBRUARY OF 2025',
    aboutHistoryDate1: 'February 2025',
    aboutHistoryText1: 'LIEPNET™ was founded',
    aboutHistoryDate2: 'February 21st, 2025',
    aboutHistoryText2: 'First LIEPNET™ official server was made',
    aboutHistoryDate3: 'April 13th, 2025',
    aboutHistoryText3: 'The LIEPNET.ID.LV website was created',
    aboutHistoryDate4: 'June 9th, 2025',
    aboutHistoryText4: 'The LIEPNET™ Weather project was created',
    aboutHistoryDate5: 'August 8th, 2025',
    aboutHistoryText5: 'The LIEPNET™ SERVER 1 was installed',
    aboutHistoryDate6: 'August 19th, 2025',
    aboutHistoryText6: 'The LIEPNET.EU website was created',
    aboutHistoryDate7: 'September 25th, 2025',
    aboutHistoryText7: 'AUDIOBOOKSHELF.LIEPNET.ID.LV was published',
    aboutHistoryDate8: 'October 13th, 2025',
    aboutHistoryText8: 'AZURACAST.LIEPNET.ID.LV was published',
    aboutHistoryDate9: 'November 2nd, 2025',
    aboutHistoryText9: 'The LIEPNET™ SERVER 1 was upgraded from 16 GB RAM to 96 GB RAM capacity',
    aboutHistoryDate10: 'December 16th, 2025',
    aboutHistoryText10: 'Major LIEPNET™ system downtime',
    aboutHistoryDate11: 'January 8th, 2026',
    aboutHistoryText11: 'LIEPNET™ acquired LIEPNET.CLOUD',
  },
  lv: {
    // Navigation
    about: 'Par mums',
    ...
    // About page content
    aboutWhatsLiepnet: "KAS IR LIEPNET™?",
    aboutOurMission: 'MŪSU MISIJA',
    aboutMission1Title: 'LATVIJAS PIRMAIS BEZPEĻŅAS KOLEKTĪVAIS METEOROLOĢISKAIS TĪKLS',
    aboutMission1Desc: 'Mūsu mērķis ir izveidot pirmo bezpeļņas kolektīvo meteoroloģisko tīklu Latvijā, kas piedāvās reāllaika datus bez maksas un papildu datus par nelielu maksu.',
    aboutMission2Title: 'PIEEJAMI HOSTINGA RISINĀJUMI',
    aboutMission2Desc: 'Mūsu mērķis ir nodrošināt pieejamus hostinga pakalpojumus uzņēmumiem un privātpersonām neatkarīgi no tā, vai tiem nepieciešams vietņu hostings, radio staciju programmatūras hostings vai Discord botu hostings.',
    aboutMission3Title: 'PALĪDZĪBA UZŅĒMUMIEM AR TEHNISKĀM PROBLĒMĀM',
    aboutMission3Desc: 'Mūsu mērķis ir palīdzēt Latvijas uzņēmumiem risināt tehnoloģiskās problēmas un izstrādāt daudz labākus risinājumus; mēs varam palīdzēt uzņēmumiem ar WI-FI un tīkla plānošanu.',
    aboutOurHistory: 'MŪSU VĒSTURE',
    aboutFoundedIn: 'DIBINĀTS 2025. GADA FEBRUĀRĪ',
    aboutHistoryDate1: '2025. gada februāris',
    aboutHistoryText1: 'LIEPNET™ tika dibināts',
    aboutHistoryDate2: '2025. gada 21. februāris',
    aboutHistoryText2: 'Tika izveidots pirmais LIEPNET™ oficiālais serveris',
    aboutHistoryDate3: '2025. gada 13. aprīlis',
    aboutHistoryText3: 'Tika izveidota LIEPNET.ID.LV vietne',
    aboutHistoryDate4: '2025. gada 9. jūnijs',
    aboutHistoryText4: 'Tika izveidots LIEPNET™ Weather projekts',
    aboutHistoryDate5: '2025. gada 8. augusts',
    aboutHistoryText5: 'Tika uzstādīts LIEPNET™ SERVER 1',
    aboutHistoryDate6: '2025. gada 19. augusts',
    aboutHistoryText6: 'Tika izveidota LIEPNET.EU vietne',
    aboutHistoryDate7: '2025. gada 25. septembris',
    aboutHistoryText7: 'Tika publicēts AUDIOBOOKSHELF.LIEPNET.ID.LV',
    aboutHistoryDate8: '2025. gada 13. oktobris',
    aboutHistoryText8: 'Tika publicēts AZURACAST.LIEPNET.ID.LV',
    aboutHistoryDate9: '2025. gada 2. novembris',
    aboutHistoryText9: 'LIEPNET™ SERVER 1 tika uzlabots no 16 GB RAM uz 96 GB RAM ietilpību',
    aboutHistoryDate10: '2025. gada 16. decembris',
    aboutHistoryText10: 'Nopietns LIEPNET™ sistēmas dīkstāves laiks',
    aboutHistoryDate11: '2026. gada 8. janvāris',
    aboutHistoryText11: 'LIEPNET™ iegādājās LIEPNET.CLOUD',
  },
  ru: {
    // Navigation
    about: 'О нас',
    ...
    // About page content
    aboutWhatsLiepnet: "ЧТО ТАКОЕ LIEPNET™?",
    aboutOurMission: 'НАША МИССИЯ',
    aboutMission1Title: 'ПЕРВАЯ В ЛАТВИИ НЕКОММЕРЧЕСКАЯ КРАУДСОРСИНГОВАЯ МЕТЕОРОЛОГИЧЕСКАЯ СЕТЬ',
    aboutMission1Desc: 'Наша цель — создать первую некоммерческую краудсорсинговую метеорологическую сеть в Латвии, которая будет предоставлять данные в реальном времени бесплатно, а дополнительные данные — за символическую плату.',
    aboutMission2Title: 'ДОСТУПНЫЕ ХОСТИНГОВЫЕ РЕШЕНИЯ',
    aboutMission2Desc: 'Наша цель — предоставить доступные хостинговые услуги для предприятий и частных лиц, будь то хостинг веб-сайтов, программного обеспечения для радиостанций или Discord-ботов.',
    aboutMission3Title: 'ПОМОЩЬ БИЗНЕСУ С ТЕХНИЧЕСКИМИ ПРОБЛЕМАМИ',
    aboutMission3Desc: 'Мы стремимся помочь латвийским компаниям справиться с технологическими проблемами и разработать значительно лучшие решения; мы можем помочь предприятиям с планированием WI-FI и сетей.',
    aboutOurHistory: 'НАША ИСТОРИЯ',
    aboutFoundedIn: 'ОСНОВАН В ФЕВРАЛЕ 2025 ГОДА',
    aboutHistoryDate1: 'Февраль 2025',
    aboutHistoryText1: 'LIEPNET™ был основан',
    aboutHistoryDate2: '21 февраля 2025',
    aboutHistoryText2: 'Был создан первый официальный сервер LIEPNET™',
    aboutHistoryDate3: '13 апреля 2025',
    aboutHistoryText3: 'Был создан веб-сайт LIEPNET.ID.LV',
    aboutHistoryDate4: '9 июня 2025',
    aboutHistoryText4: 'Был создан проект LIEPNET™ Weather',
    aboutHistoryDate5: '8 августа 2025',
    aboutHistoryText5: 'Был установлен LIEPNET™ SERVER 1',
    aboutHistoryDate6: '19 августа 2025',
    aboutHistoryText6: 'Был создан веб-сайт LIEPNET.EU',
    aboutHistoryDate7: '25 сентября 2025',
    aboutHistoryText7: 'Был опубликован AUDIOBOOKSHELF.LIEPNET.ID.LV',
    aboutHistoryDate8: '13 октября 2025',
    aboutHistoryText8: 'Был опубликован AZURACAST.LIEPNET.ID.LV',
    aboutHistoryDate9: '2 ноября 2025',
    aboutHistoryText9: 'LIEPNET™ SERVER 1 был обновлён с 16 ГБ ОЗУ до 96 ГБ ОЗУ',
    aboutHistoryDate10: '16 декабря 2025',
    aboutHistoryText10: 'Крупный простой системы LIEPNET™',
    aboutHistoryDate11: '8 января 2026',
    aboutHistoryText11: 'LIEPNET™ приобрёл LIEPNET.CLOUD',
  },
  fr: {
    // Navigation
    about: 'À propos',
    ...
    // About page content
    aboutWhatsLiepnet: "QU'EST-CE QUE LIEPNET™ ?",
    aboutOurMission: 'NOTRE MISSION',
    aboutMission1Title: 'PREMIER RÉSEAU MÉTÉOROLOGIQUE PARTICIPATIF À BUT NON LUCRATIF EN LETTONIE',
    aboutMission1Desc: 'Notre objectif est d\'établir le premier réseau météorologique participatif à but non lucratif en Lettonie, qui offrira des données en temps réel gratuitement et des données supplémentaires pour un prix modique.',
    aboutMission2Title: 'SOLUTIONS D\'HÉBERGEMENT ABORDABLES',
    aboutMission2Desc: 'Notre objectif est de fournir des services d\'hébergement abordables pour les entreprises et les particuliers, qu\'ils aient besoin d\'hébergement de sites web, de logiciels de stations de radio ou de bots Discord.',
    aboutMission3Title: 'AIDE AUX ENTREPRISES AVEC LES PROBLÈMES TECHNIQUES',
    aboutMission3Desc: 'Nous visons à aider les entreprises lettones à faire face aux défis technologiques et à développer de bien meilleures solutions ; nous pouvons aider les entreprises avec la planification WI-FI et réseau.',
    aboutOurHistory: 'NOTRE HISTOIRE',
    aboutFoundedIn: 'FONDÉ EN FÉVRIER 2025',
    aboutHistoryDate1: 'Février 2025',
    aboutHistoryText1: 'LIEPNET™ a été fondé',
    aboutHistoryDate2: '21 février 2025',
    aboutHistoryText2: 'Le premier serveur officiel LIEPNET™ a été créé',
    aboutHistoryDate3: '13 avril 2025',
    aboutHistoryText3: 'Le site web LIEPNET.ID.LV a été créé',
    aboutHistoryDate4: '9 juin 2025',
    aboutHistoryText4: 'Le projet LIEPNET™ Weather a été créé',
    aboutHistoryDate5: '8 août 2025',
    aboutHistoryText5: 'Le LIEPNET™ SERVER 1 a été installé',
    aboutHistoryDate6: '19 août 2025',
    aboutHistoryText6: 'Le site web LIEPNET.EU a été créé',
    aboutHistoryDate7: '25 septembre 2025',
    aboutHistoryText7: 'AUDIOBOOKSHELF.LIEPNET.ID.LV a été publié',
    aboutHistoryDate8: '13 octobre 2025',
    aboutHistoryText8: 'AZURACAST.LIEPNET.ID.LV a été publié',
    aboutHistoryDate9: '2 novembre 2025',
    aboutHistoryText9: 'Le LIEPNET™ SERVER 1 a été mis à niveau de 16 Go de RAM à 96 Go de RAM',
    aboutHistoryDate10: '16 décembre 2025',
    aboutHistoryText10: 'Panne majeure du système LIEPNET™',
    aboutHistoryDate11: '8 janvier 2026',
    aboutHistoryText11: 'LIEPNET™ a acquis LIEPNET.CLOUD',
  },
  el: {
    // Navigation
    about: 'Σχετικά',
    ...
    // About page content
    aboutWhatsLiepnet: "ΤΙ ΕΊΝΑΙ ΤΟ LIEPNET™;",
    aboutOurMission: 'Η ΑΠΟΣΤΟΛΗ ΜΑΣ',
    aboutMission1Title: 'ΤΟ ΠΡΩΤΟ ΜΗ ΚΕΡΔΟΣΚΟΠΙΚΟ ΣΥΜΜΕΤΟΧΙΚΟ ΜΕΤΕΩΡΟΛΟΓΙΚΟ ΔΙΚΤΥΟ ΤΗΣ ΛΕΤΟΝΙΑΣ',
    aboutMission1Desc: 'Στόχος μας είναι να δημιουργήσουμε το πρώτο μη κερδοσκοπικό συμμετοχικό μετεωρολογικό δίκτυο στη Λετονία, το οποίο θα προσφέρει δεδομένα σε πραγματικό χρόνο χωρίς κόστος και συμπληρωματικά δεδομένα με μικρό τέλος.',
    aboutMission2Title: 'ΠΡΟΣΙΤΕΣ ΛΥΣΕΙΣ ΦΙΛΟΞΕΝΙΑΣ',
    aboutMission2Desc: 'Στόχος μας είναι να παρέχουμε προσιτές υπηρεσίες φιλοξενίας για επιχειρήσεις και ιδιώτες, ανεξάρτητα αν χρειάζονται φιλοξενία ιστοσελίδων, λογισμικό ραδιοφωνικών σταθμών ή φιλοξενία Discord bot.',
    aboutMission3Title: 'ΒΟΗΘΕΙΑ ΣΕ ΕΠΙΧΕΙΡΗΣΕΙΣ ΜΕ ΤΕΧΝΙΚΑ ΠΡΟΒΛΗΜΑΤΑ',
    aboutMission3Desc: 'Στοχεύουμε να βοηθήσουμε τις λετονικές εταιρείες να αντιμετωπίσουν τεχνολογικές προκλήσεις και να αναπτύξουν πολύ καλύτερες λύσεις· μπορούμε να βοηθήσουμε τις επιχειρήσεις με σχεδιασμό WI-FI και δικτύων.',
    aboutOurHistory: 'Η ΙΣΤΟΡΙΑ ΜΑΣ',
    aboutFoundedIn: 'ΙΔΡΥΘΗΚΕ ΤΟΝ ΦΕΒΡΟΥΑΡΙΟ ΤΟΥ 2025',
    aboutHistoryDate1: 'Φεβρουάριος 2025',
    aboutHistoryText1: 'Ιδρύθηκε το LIEPNET™',
    aboutHistoryDate2: '21 Φεβρουαρίου 2025',
    aboutHistoryText2: 'Δημιουργήθηκε ο πρώτος επίσημος διακομιστής LIEPNET™',
    aboutHistoryDate3: '13 Απριλίου 2025',
    aboutHistoryText3: 'Δημιουργήθηκε ο ιστότοπος LIEPNET.ID.LV',
    aboutHistoryDate4: '9 Ιουνίου 2025',
    aboutHistoryText4: 'Δημιουργήθηκε το έργο LIEPNET™ Weather',
    aboutHistoryDate5: '8 Αυγούστου 2025',
    aboutHistoryText5: 'Εγκαταστάθηκε ο LIEPNET™ SERVER 1',
    aboutHistoryDate6: '19 Αυγούστου 2025',
    aboutHistoryText6: 'Δημιουργήθηκε ο ιστότοπος LIEPNET.EU',
    aboutHistoryDate7: '25 Σεπτεμβρίου 2025',
    aboutHistoryText7: 'Δημοσιεύτηκε το AUDIOBOOKSHELF.LIEPNET.ID.LV',
    aboutHistoryDate8: '13 Οκτωβρίου 2025',
    aboutHistoryText8: 'Δημοσιεύτηκε το AZURACAST.LIEPNET.ID.LV',
    aboutHistoryDate9: '2 Νοεμβρίου 2025',
    aboutHistoryText9: 'Ο LIEPNET™ SERVER 1 αναβαθμίστηκε από 16 GB RAM σε 96 GB RAM',
    aboutHistoryDate10: '16 Δεκεμβρίου 2025',
    aboutHistoryText10: 'Σημαντική διακοπή λειτουργίας του συστήματος LIEPNET™',
    aboutHistoryDate11: '8 Ιανουαρίου 2026',
    aboutHistoryText11: 'Το LIEPNET™ απέκτησε το LIEPNET.CLOUD',
  },
  de: {
    // Navigation
    about: 'Über uns',
    ...
    // About page content
    aboutWhatsLiepnet: "WAS IST LIEPNET™?",
    aboutOurMission: 'UNSERE MISSION',
    aboutMission1Title: 'LETTLANDS ERSTES GEMEINNÜTZIGES CROWDSOURCED METEOROLOGISCHES NETZWERK',
    aboutMission1Desc: 'Unser Ziel ist es, das erste gemeinnützige, crowdsourcte meteorologische Netzwerk in Lettland aufzubauen, das Echtzeitdaten kostenlos und ergänzende Daten für eine geringe Gebühr anbietet.',
    aboutMission2Title: 'ERSCHWINGLICHE HOSTING-LÖSUNGEN',
    aboutMission2Desc: 'Unser Ziel ist es, erschwingliche Hosting-Dienste für Unternehmen und Privatpersonen anzubieten, unabhängig davon, ob sie Website-Hosting, Radiosender-Software-Hosting oder Discord-Bot-Hosting benötigen.',
    aboutMission3Title: 'UNTERSTÜTZUNG VON UNTERNEHMEN BEI TECHNISCHEN PROBLEMEN',
    aboutMission3Desc: 'Wir möchten lettischen Unternehmen bei technologischen Herausforderungen helfen und deutlich bessere Lösungen entwickeln; wir können Unternehmen bei der WI-FI- und Netzwerkplanung unterstützen.',
    aboutOurHistory: 'UNSERE GESCHICHTE',
    aboutFoundedIn: 'GEGRÜNDET IM FEBRUAR 2025',
    aboutHistoryDate1: 'Februar 2025',
    aboutHistoryText1: 'LIEPNET™ wurde gegründet',
    aboutHistoryDate2: '21. Februar 2025',
    aboutHistoryText2: 'Der erste offizielle LIEPNET™-Server wurde erstellt',
    aboutHistoryDate3: '13. April 2025',
    aboutHistoryText3: 'Die Website LIEPNET.ID.LV wurde erstellt',
    aboutHistoryDate4: '9. Juni 2025',
    aboutHistoryText4: 'Das LIEPNET™ Weather Projekt wurde erstellt',
    aboutHistoryDate5: '8. August 2025',
    aboutHistoryText5: 'Der LIEPNET™ SERVER 1 wurde installiert',
    aboutHistoryDate6: '19. August 2025',
    aboutHistoryText6: 'Die Website LIEPNET.EU wurde erstellt',
    aboutHistoryDate7: '25. September 2025',
    aboutHistoryText7: 'AUDIOBOOKSHELF.LIEPNET.ID.LV wurde veröffentlicht',
    aboutHistoryDate8: '13. Oktober 2025',
    aboutHistoryText8: 'AZURACAST.LIEPNET.ID.LV wurde veröffentlicht',
    aboutHistoryDate9: '2. November 2025',
    aboutHistoryText9: 'Der LIEPNET™ SERVER 1 wurde von 16 GB RAM auf 96 GB RAM aufgerüstet',
    aboutHistoryDate10: '16. Dezember 2025',
    aboutHistoryText10: 'Größerer LIEPNET™-Systemausfall',
    aboutHistoryDate11: '8. Januar 2026',
    aboutHistoryText11: 'LIEPNET™ hat LIEPNET.CLOUD erworben',
  },
  lt: {
    // Navigation
    about: 'Apie mus',
    ...
    // About page content
    aboutWhatsLiepnet: "KAS YRA LIEPNET™?",
    aboutOurMission: 'MŪSŲ MISIJA',
    aboutMission1Title: 'PIRMASIS LATVIJOS NESIEKIANTIS PELNO KOLEKTYVINIS METEOROLOGINIS TINKLAS',
    aboutMission1Desc: 'Mūsų tikslas yra sukurti pirmąjį nesiekiantį pelno kolektyvinį meteorologinį tinklą Latvijoje, kuris siūlys duomenis realiuoju laiku nemokamai ir papildomus duomenis už nedidelį mokestį.',
    aboutMission2Title: 'PRIEINAMI PRIEGLOBOS SPRENDIMAI',
    aboutMission2Desc: 'Mūsų tikslas yra teikti prieinamas prieglobos paslaugas verslams ir privatiems asmenims, nesvarbu, ar jiems reikia svetainių prieglobos, radijo stočių programinės įrangos prieglobos ar Discord botų prieglobos.',
    aboutMission3Title: 'PAGALBA VERSLUI SU TECHNINĖMIS PROBLEMOMIS',
    aboutMission3Desc: 'Siekiame padėti Latvijos įmonėms spręsti technologines problemas ir kurti gerokai geresnius sprendimus; galime padėti verslams su WI-FI ir tinklų planavimu.',
    aboutOurHistory: 'MŪSŲ ISTORIJA',
    aboutFoundedIn: 'ĮKURTA 2025 M. VASARĮ',
    aboutHistoryDate1: '2025 m. vasaris',
    aboutHistoryText1: 'LIEPNET™ buvo įkurta',
    aboutHistoryDate2: '2025 m. vasario 21 d.',
    aboutHistoryText2: 'Buvo sukurtas pirmasis oficialus LIEPNET™ serveris',
    aboutHistoryDate3: '2025 m. balandžio 13 d.',
    aboutHistoryText3: 'Buvo sukurta svetainė LIEPNET.ID.LV',
    aboutHistoryDate4: '2025 m. birželio 9 d.',
    aboutHistoryText4: 'Buvo sukurtas LIEPNET™ Weather projektas',
    aboutHistoryDate5: '2025 m. rugpjūčio 8 d.',
    aboutHistoryText5: 'Buvo įdiegtas LIEPNET™ SERVER 1',
    aboutHistoryDate6: '2025 m. rugpjūčio 19 d.',
    aboutHistoryText6: 'Buvo sukurta svetainė LIEPNET.EU',
    aboutHistoryDate7: '2025 m. rugsėjo 25 d.',
    aboutHistoryText7: 'Buvo paskelbtas AUDIOBOOKSHELF.LIEPNET.ID.LV',
    aboutHistoryDate8: '2025 m. spalio 13 d.',
    aboutHistoryText8: 'Buvo paskelbtas AZURACAST.LIEPNET.ID.LV',
    aboutHistoryDate9: '2025 m. lapkričio 2 d.',
    aboutHistoryText9: 'LIEPNET™ SERVER 1 buvo atnaujintas nuo 16 GB RAM iki 96 GB RAM talpos',
    aboutHistoryDate10: '2025 m. gruodžio 16 d.',
    aboutHistoryText10: 'Didelė LIEPNET™ sistemos prastova',
    aboutHistoryDate11: '2026 m. sausio 8 d.',
    aboutHistoryText11: 'LIEPNET™ įsigijo LIEPNET.CLOUD',
  },
  et: {
    // Navigation
    about: 'Meist',
    ...
    // About page content
    aboutWhatsLiepnet: "MIS ON LIEPNET™?",
    aboutOurMission: 'MEIE MISSIOON',
    aboutMission1Title: 'LÄTI ESIMENE MITTETULUNDUSLIK RAHVAPÕHINE METEOROLOOGILINE VÕRGUSTIK',
    aboutMission1Desc: 'Meie eesmärk on luua esimene mittetulunduslik rahvapõhine meteoroloogiline võrgustik Lätis, mis pakub reaalajas andmeid tasuta ja täiendavaid andmeid sümboolse tasu eest.',
    aboutMission2Title: 'TASKUKOHASED HOSTINGU LAHENDUSED',
    aboutMission2Desc: 'Meie eesmärk on pakkuda taskukohaseid hostingu teenuseid ettevõtetele ja eraisikutele, olenemata sellest, kas nad vajavad veebilehe hostingut, raadiojaamade tarkvara hostingut või Discord boti hostingut.',
    aboutMission3Title: 'ETTEVÕTETE ABISTAMINE TEHNILISTE PROBLEEMIDEGA',
    aboutMission3Desc: 'Meie eesmärk on aidata Läti ettevõtetel toime tulla tehnoloogiliste väljakutsetega ja arendada palju paremaid lahendusi; saame aidata ettevõtteid WI-FI ja võrgu planeerimisega.',
    aboutOurHistory: 'MEIE AJALUGU',
    aboutFoundedIn: 'ASUTATUD 2025. AASTA VEEBRUARIS',
    aboutHistoryDate1: 'Veebruar 2025',
    aboutHistoryText1: 'LIEPNET™ asutati',
    aboutHistoryDate2: '21. veebruar 2025',
    aboutHistoryText2: 'Loodi esimene ametlik LIEPNET™ server',
    aboutHistoryDate3: '13. aprill 2025',
    aboutHistoryText3: 'Loodi veebileht LIEPNET.ID.LV',
    aboutHistoryDate4: '9. juuni 2025',
    aboutHistoryText4: 'Loodi LIEPNET™ Weather projekt',
    aboutHistoryDate5: '8. august 2025',
    aboutHistoryText5: 'Paigaldati LIEPNET™ SERVER 1',
    aboutHistoryDate6: '19. august 2025',
    aboutHistoryText6: 'Loodi veebileht LIEPNET.EU',
    aboutHistoryDate7: '25. september 2025',
    aboutHistoryText7: 'Avaldati AUDIOBOOKSHELF.LIEPNET.ID.LV',
    aboutHistoryDate8: '13. oktoober 2025',
    aboutHistoryText8: 'Avaldati AZURACAST.LIEPNET.ID.LV',
    aboutHistoryDate9: '2. november 2025',
    aboutHistoryText9: 'LIEPNET™ SERVER 1 uuendati 16 GB RAM-lt 96 GB RAM mahutavusele',
    aboutHistoryDate10: '16. detsember 2025',
    aboutHistoryText10: 'Suur LIEPNET™ süsteemi seisak',
    aboutHistoryDate11: '8. jaanuar 2026',
    aboutHistoryText11: 'LIEPNET™ omandas LIEPNET.CLOUD',
  },
  sv: {
    // Navigation
    about: 'Om oss',
    ...
    // About page content
    aboutWhatsLiepnet: "VAD ÄR LIEPNET™?",
    aboutOurMission: 'VÅRT UPPDRAG',
    aboutMission1Title: 'LETTLANDS FÖRSTA IDEELLA CROWDSOURCADE METEOROLOGISKA NÄTVERK',
    aboutMission1Desc: 'Vårt mål är att etablera det första ideella crowdsourcade meteorologiska nätverket i Lettland, som kommer att erbjuda realtidsdata utan kostnad och kompletterande data för en liten avgift.',
    aboutMission2Title: 'PRISVÄRDA HOSTINGLÖSNINGAR',
    aboutMission2Desc: 'Vårt mål är att tillhandahålla prisvärda hostingtjänster för företag och privatpersoner, oavsett om de behöver webbplatshosting, radiostation-programvara-hosting eller Discord-bot-hosting.',
    aboutMission3Title: 'HJÄLPA FÖRETAG MED TEKNISKA PROBLEM',
    aboutMission3Desc: 'Vi strävar efter att hjälpa lettiska företag att hantera teknologiska utmaningar och utveckla mycket bättre lösningar; vi kan hjälpa företag med WI-FI och nätverksplanering.',
    aboutOurHistory: 'VÅR HISTORIA',
    aboutFoundedIn: 'GRUNDAT I FEBRUARI 2025',
    aboutHistoryDate1: 'Februari 2025',
    aboutHistoryText1: 'LIEPNET™ grundades',
    aboutHistoryDate2: '21 februari 2025',
    aboutHistoryText2: 'Första officiella LIEPNET™-servern skapades',
    aboutHistoryDate3: '13 april 2025',
    aboutHistoryText3: 'Webbplatsen LIEPNET.ID.LV skapades',
    aboutHistoryDate4: '9 juni 2025',
    aboutHistoryText4: 'LIEPNET™ Weather-projektet skapades',
    aboutHistoryDate5: '8 augusti 2025',
    aboutHistoryText5: 'LIEPNET™ SERVER 1 installerades',
    aboutHistoryDate6: '19 augusti 2025',
    aboutHistoryText6: 'Webbplatsen LIEPNET.EU skapades',
    aboutHistoryDate7: '25 september 2025',
    aboutHistoryText7: 'AUDIOBOOKSHELF.LIEPNET.ID.LV publicerades',
    aboutHistoryDate8: '13 oktober 2025',
    aboutHistoryText8: 'AZURACAST.LIEPNET.ID.LV publicerades',
    aboutHistoryDate9: '2 november 2025',
    aboutHistoryText9: 'LIEPNET™ SERVER 1 uppgraderades från 16 GB RAM till 96 GB RAM',
    aboutHistoryDate10: '16 december 2025',
    aboutHistoryText10: 'Större LIEPNET™-systemavbrott',
    aboutHistoryDate11: '8 januari 2026',
    aboutHistoryText11: 'LIEPNET™ förvärvade LIEPNET.CLOUD',
  },
};
